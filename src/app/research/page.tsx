    ...
    <div className="flex flex-col gap-20 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      ...
      <header className="flex flex-col gap-4">
        ...
        <p className="max-w-3xl text-lg text-slate-600">
          My academic journey is a continuous evolution from macroscopic catalyst engineering to uncovering the most fundamental solid-state electrochemical thermodynamics.
        </p>
      </header>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-8 mt-4">
          <section className="flex flex-col gap-3">
            <h3 className="text-xl font-bold text-[#A31F34]">Solid-State Electrochemical Thermodynamics</h3>
          ...
          <section className="flex flex-col gap-3">
            <h3 className="text-xl font-bold text-[#A31F34]">Charge Transport & Defect Thermodynamics in MIECs</h3>
          ...
          <section className="flex flex-col gap-3">
            <h3 className="text-xl font-bold text-[#A31F34]">Advanced Electro-analysis of Battery Heterogeneity</h3>
        ...
        <div className="relative flex justify-center">
          <div className="bg-white px-8 py-8 rounded-2xl border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex flex-col items-center gap-5 text-center max-w-2xl transform transition duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(255,108,12,0.15)] hover:border-[#FF6C0C]">
            ...
            <p className="text-slate-600 text-base leading-relaxed px-4">
              Discover why I shifted my focus from surface-level synthetic electrocatalysis towards the rigorous thermodynamic and solid-state physical frameworks of real energy systems.
            </p>
            <Link 
      ...
      <div className="flex flex-col gap-8 opacity-70 hover:opacity-100 transition-opacity duration-700">
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-4">
          <div className="p-6 rounded-xl border border-slate-200 bg-slate-50">
            <h3 className="text-lg font-bold text-slate-800 mb-2">Electrochemical Co-reduction</h3>
            <p className="text-sm text-slate-600 mb-4 leading-relaxed">Understanding catalytic mechanisms under competing reactants and developing catalysts for CO2/nitrate co-reduction to urea.</p>
