...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} scroll-smooth`}>
      <body className="font-sans min-h-screen flex flex-col bg-slate-50 text-slate-900 selection:bg-blue-100 selection:text-blue-900">
        ...
        <footer className="border-t border-slate-200 bg-white py-8 mt-auto">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-between gap-4 sm:flex-row text-sm text-slate-500">
            <p>© {new Date().getFullYear()} Stephen Kang. All rights reserved.</p>
            <div className="flex gap-4">
              <a href="mailto:email@example.com" className="hover:text-blue-600 transition-colors">Email</a>
              <a href="#" className="hover:text-blue-600 transition-colors">Google Scholar</a>
            </div>
          </div>
        </footer>
      </body>
